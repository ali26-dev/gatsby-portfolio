  ...
  <Content offset={offset + 0.025} speed={0} factor={0.3} style={{ zIndex: `99999` }}>
    ...
    <FooterWrapper>
      <SocialList>
        ...
        <li><a href='https://deviantart.com/' aria-label='DeviantArt'><FontAwesomeIcon icon={faDeviantart} /></a></li>
        <li><a href='https://twitter.com/ali26_codes' aria-label='Twitter'><FontAwesomeIcon icon={faTwitter} /></a></li>
        <li><a href='https://dribbble.com/' aria-label='Dribbble'><FontAwesomeIcon icon={faDribbble} /></a></li>
        <li><a href='https://linkedin.com/' aria-label='LinkedIn'><FontAwesomeIcon icon={faLinkedinIn} /></a></li>
      </SocialList>
      &copy; 2020 by &nbsp;
