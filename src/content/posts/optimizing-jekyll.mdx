...
---
  ...
  <p class="h-tip">
  For a more up-to-date and comprehensive explanation this subject has been revisited <a href="https://ali26.dev/blog/optimizing-jekyll-with-gulp-revisited.html">here</a>
  </p>
